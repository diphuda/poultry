<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="./index.html">
            <img src="./assets/img/brand/poultry-logo.png" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="./raw-items.html">
                        <i class="fas fa-pizza-slice text-green"></i> Raw Items
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="feed-making.html">
                        <i class="ni ni-bullet-list-67 text-teal"></i> Feed Making
                    </a>
                </li>
                <li class="nav-item">
