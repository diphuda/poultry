...
@if(isset($distribution))
    @section('title', 'Edit Raw Distribution')
@else
    @section('title', 'Sell Raw Item')
@endif
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                @if(isset($distribution))
                                    <h3 class="mb-0">Edit Raw Distribution</h3>
                                @else
                                    <h3 class="mb-0">Sell Raw Item</h3>
                                @endif
                            </div>
                        </div>
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                        <form action="{{ isset($distribution) ? route('raw-sell.update', $distribution->id) : route('raw-sell.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @isset($distribution)
                                @method('PUT')
                            @endisset
                            ...
                            @else
                                <button class="btn btn-icon btn-success float-right" type="submit">
                                    ...
                                    <span class="btn-inner--text">Sell Raw Item</span>
                                </button>
                            @endisset
                        </form>
                    </div>
